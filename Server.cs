...
namespace MCForge
{
	public class Server
	{
        ...
        internal static readonly List<string> devs = new List<string>(new string[] { "501st_commander", "Lavoaster", "Alem_Zupa", "BeMacized", "Shade2010", "Dmitchell94", "edh649", "hypereddie10", "Wouto1997" });
